          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              {(() => {
                ...
                const hasAdjustments = delivery || shipping || expedite || vat || ewt || underpayment || overpayment || discount;
                ...
                return (
                  <div className="rounded-lg border bg-muted/30 p-4 space-y-2">
                    ...
                    {delivery > 0 && (<div className="flex justify-between text-sm"><span className="text-muted-foreground">Delivery Fee</span><span>+ {fmt(delivery)}</span></div>)}
                    {shipping > 0 && (<div className="flex justify-between text-sm"><span className="text-muted-foreground">Shipping Fee</span><span>+ {fmt(shipping)}</span></div>)}
                    {expedite > 0 && (<div className="flex justify-between text-sm"><span className="text-muted-foreground">Expedite Fee</span><span>+ {fmt(expedite)}</span></div>)}
                    {vat > 0 && (<div className="flex justify-between text-sm"><span className="text-muted-foreground">VAT</span><span>+ {fmt(vat)}</span></div>)}
                    {underpayment > 0 && (<div className="flex justify-between text-sm"><span className="text-muted-foreground">Underpayment</span><span>+ {fmt(underpayment)}</span></div>)}
                    {ewt > 0 && (<div className="flex justify-between text-sm"><span className="text-muted-foreground">EWT</span><span>- {fmt(ewt)}</span></div>)}
                    {overpayment > 0 && (<div className="flex justify-between text-sm"><span className="text-muted-foreground">Overpayment Credit</span><span>- {fmt(overpayment)}</span></div>)}
                    {discount > 0 && (<div className="flex justify-between text-sm"><span className="text-muted-foreground">Discount</span><span>- {fmt(discount)}</span></div>)}
